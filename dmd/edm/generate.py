...
def load_model(network_path_or_url: str, device: torch.types.Device) -> torch.nn.Module:
    with dnnlib.util.open_url(network_path_or_url, verbose=(dist.get_rank() == 0)) as f:
